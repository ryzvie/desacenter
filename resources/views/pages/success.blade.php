        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center">
                    <img src="{{ asset('assets/images/finish.svg') }}" style="width:350px"/>
                    <div style="margin-top:10px; color:#000;">
                        Selamat pendaftaran untuk mengikuti program desabrilian telah berhasil. <br>
                        Silahkan untuk tunggu konfirmasi untuk lolos seleksi program.
